...
# 🎮 大侠狂想曲 — Community Edition

**Standalone Community Edition of the wuxia RPG 大侠狂想曲**
...
大侠狂想曲 (Daxia Kuangxiangqu) is a wuxia-themed role-playing game set in an open jianghu world, combining martial arts progression, sect politics, and branching storylines. This Community Edition is a standalone build distributed as a self-contained package. No storefront and no additional software are required, and the game is ready to play immediately after installation.

This build is intended for players who want an independent, offline release of 大侠狂想曲 that runs on Windows PC without additional software.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4125770/5ba08f5fec81797c6f578d4a12eff2fc8a997d07/ss_5ba08f5fec81797c6f578d4a12eff2fc8a997d07.1920x1080.jpg?t=1788081045" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4125770/01cf29aa17d2b3755596ba8a4c39606418eb140c/ss_01cf29aa17d2b3755596ba8a4c39606418eb140c.1920x1080.jpg?t=1788081045" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4125770/e376fae69aede9368fea1cf2fc6282ba309c801b/ss_e376fae69aede9368fea1cf2fc6282ba309c801b.1920x1080.jpg?t=1788081045" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- **Interface:** Simplified Chinese, English
...
- 🗺️ **Open Jianghu World** — Explore a freely traversable world of towns, wilderness, and sect strongholds.
- ⚔️ **Martial Arts Progression** — Learn techniques, train attributes, and build a custom fighting style.
- 📖 **Branching Storylines** — Choices shape reputation, alliances, and multiple narrative outcomes.
- 🏯 **Sect System** — Join or rival martial sects and navigate faction politics.
- 🤝 **Companions** — Recruit allies with their own stories and combat abilities.
- 🔌 **Fully Offline Play** — Standalone build runs without a storefront client or persistent connection.
- 💾 **Self-Contained Package** — Includes all base game content in a single installer, ready to play immediately.
- 🌐 **Multilingual Interface** — Interface available in Simplified Chinese and English.
...
| **RAM** | 4 GB | 8 GB |
| **Graphics** | DirectX 10 compatible GPU, 1 GB VRAM | DirectX 11 dedicated GPU, 2 GB VRAM (e.g., GTX 1050 / RX 560) |
| **Storage** | 4 GB available space | 6 GB available space (SSD recommended) |
| **Additional** | DirectX 10, mouse and keyboard | DirectX 11, mouse and keyboard |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\大侠狂想曲\Saved`
